...
public class JDBC {
    ...
    private void updateClanWar(JSONObject jsonObject) throws SQLException {
        ...
        // war has not been added to the database. This means we do not need to check again, and we can just add the data to the database
        int warSize = (int) jsonObject.get("teamSize");
